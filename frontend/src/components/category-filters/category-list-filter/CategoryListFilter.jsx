...
const CategoryListFilter = ({ options }) => {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedOptions, setSelectedOptions] = useState(
    useSelector(selectCategoryListFilter)
  );
  ...
  const handleFilterApply = () => {
    toggleDropdown();
    dispatch(setCategoryListFilter(selectedOptions));
  };

  const handleFilterReset = () => {
    setSelectedOptions([]);
    dispatch(resetCategoryListFilter);
    dispatch(setCategoryListFilter([]));
  };
